...
class Base
{
	...
	public function getAll ()
	{
		...
		//$sql = "select * from student join grade on student.gid=grade.id";
		$sql = "select {$this->field} from {$this -> table} {$this->join} {$this->where} {$this->order}";
		//p($sql);die;
		return $this -> q ( $sql );
	}
	 ...
	 * @param $right	b.id
	 */
	public function join($table,$left,$operation,$right){
		$this->join = "join {$table} on $left $operation $right";
		//p($this->join );die;
		return $this;
	}
	/**
