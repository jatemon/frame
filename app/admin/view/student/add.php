                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">学生名称</label>
                            <div class="col-sm-10">
                                <input type="text" name="sname" class="form-control" id="" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="sage" class="form-control" id="" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
